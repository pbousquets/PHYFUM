...
@click.option("--stemCells", "stemCells", cls=CustomOption, default=3, help="Initial value for the stemCells parameter", type=int, help_group="Init")
@click.option("--delta", cls=CustomOption, default=0.2, help="Initial value for the delta parameter", type=float, help_group="Init")
@click.option("--eta", cls=CustomOption, default=0.7, help="Initial value for the eta parameter", type=float, help_group="Init")
@click.option("--kappa", cls=CustomOption, default=50, help="Initial value for the kappa parameter", type=float, help_group="Init")
@click.option("--mu", cls=CustomOption, default=0.1, help="Initial value for the mu parameter", type=float, help_group="Init")
@click.option("--gamma", cls=CustomOption, default=0.1, help="Initial value for the gamma parameter", type=float, help_group="Init")
@click.option("--lambda", "Lambda", cls=CustomOption, default=1, help="Initial value for the lambda parameter", type=float, help_group="Init")
@click.option("--popSize", "popSize", cls=CustomOption, default=1, help="Initial value for constant population size", type=float, help_group="Init")
